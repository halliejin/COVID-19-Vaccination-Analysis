...
/**
 * {@code edu.upenn.cit594.datamanagement.CharacterReader} is a wrapper for normal {@code Reader} and
...
public class CharacterReader implements AutoCloseable {
     ...
     *
     * <p>Since {@code edu.upenn.cit594.datamanagement.CharacterReader} implements {@code AutoCloseable}, this
     * method will be automatically invoked if the {@code edu.upenn.cit594.datamanagement.CharacterReader}
